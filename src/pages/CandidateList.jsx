                ...
                <Table className={classes.table} aria-label="custom pagination table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell style={{ width: 80 }} align="right">First Name</TableCell>
                            <TableCell style={{ width: 80 }} align="right">Last Name</TableCell>
                        ...
                        {(rowsPerPage > 0
                            ...
                            <TableRow key={candidate.id}>
                                <TableCell style={{ width: 80 }} align="right">
                                    <Avatar alt={candidate.name} src={candidate.userImage?.imageUrl} />
                                </TableCell>
                                <TableCell style={{ width: 80 }} align="right">
                                    {candidate.firstName}
                                </TableCell>
